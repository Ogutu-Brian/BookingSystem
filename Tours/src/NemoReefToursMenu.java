...
public class NemoReefToursMenu {
    ...
    private void enterBooking() {
        if (currentBooking == MAX_BOOKINGS) {
            JOptionPane.showMessageDialog(null, "Maximum number of bookings has been reached",
                    "Nemo Reef Tours Management System", JOptionPane.ERROR_MESSAGE);
        } else {
            String bookingName = JOptionPane.showInputDialog(null, "Please Enter the booking name",
                    "Input Booking Name", JOptionPane.QUESTION_MESSAGE);
            while (bookingName.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Error-Booking name cannot be blank", "Input Booking Name",
                        JOptionPane.ERROR_MESSAGE);
                bookingName = JOptionPane.showInputDialog(null, "Please Enter the booking name", "Input Booking Name",
                        JOptionPane.QUESTION_MESSAGE);
            }
            String passengersInput = JOptionPane.showInputDialog(null, "Please Enter the number of passengers",
                    "Input Number of Passengers", JOptionPane.QUESTION_MESSAGE);
            while (passengersInput.isEmpty() || !isStringNumeric(passengersInput)) {
                JOptionPane.showMessageDialog(null,
                        ...
                        "Input Number of Passengers", JOptionPane.ERROR_MESSAGE);
                passengersInput = JOptionPane.showInputDialog(null, "Please Enter the number of passengers",
                        "Input Number of Passengers", JOptionPane.QUESTION_MESSAGE);
            }
            int passengers = Integer.parseInt(passengersInput);
            bookings[currentBooking] = new Booking(bookingName, passengers);
            displayHeading();
            System.out.printf("%-30s%-17s%-6s\n", bookings[currentBooking].getBookingName(),
                    bookings[currentBooking].getPassengers(), "$" + bookings[currentBooking].calculateCharge());
            currentBooking += 1;
        }
    }
    ...
    private void displayAllBookings() {
        if (currentBooking == 0) {
            JOptionPane.showMessageDialog(null, "You must enter at least one Booking", "Display All Bookings",
                    JOptionPane.ERROR_MESSAGE);
        } else {
            displayHeading();
            int index = 0;
            for (Booking item : bookings) {
                ...
                System.out.printf("%-30s%-17s%-6s\n", item.getBookingName(), item.getPassengers(),
    ...
    private void displayStatistics() {
        if (currentBooking == 0) {
            JOptionPane.showMessageDialog(null, "You must enter at least one Booking", "Display Statistics",
                    JOptionPane.ERROR_MESSAGE);
        } else {
            int index = 0;
            ...
            System.out.println(leadingBooking.getBookingName() + " has the maximum number of "
                    + leadingBooking.getPassengers() + " passenger(s)");
            System.out.println(leastBooking.getBookingName() + " has the minimum number of "
                    + leastBooking.getBookingName() + " passenger(s)");
    ...
    private void searchBookings() {
        if (currentBooking == 0) {
            JOptionPane.showMessageDialog(null, "You must enter at least One Booking", "Search Bookings",
                    JOptionPane.ERROR_MESSAGE);
        } else {
            String searchBooking = JOptionPane.showInputDialog(null, "Enter Booking Name", "Search Booking",
                    JOptionPane.QUESTION_MESSAGE);
            while (searchBooking.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please Ebnter Booking Name", "Search Booking",
                        JOptionPane.ERROR_MESSAGE);
                searchBooking = JOptionPane.showInputDialog(null, "Enter Booking Name", "Search Booking",
                        JOptionPane.QUESTION_MESSAGE);
            }
            ...
            for (Booking item : bookings) {
                ...
                if (searchBooking.toLowerCase().equals(item.getBookingName().toLowerCase())) {
                    found = true;
                    booking = item;
                    break;
                }
            ...
            if (found) {
                ...
                System.out.printf("%-30s%-17s%-6s\n", booking.getBookingName(), booking.getPassengers(),
                        "$" + booking.calculateCharge());
            } else {
                JOptionPane.showMessageDialog(null, searchBooking + " not found", "Search Booking",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void sortBookings() {
        if (currentBooking == 0) {
            JOptionPane.showMessageDialog(null, "Sort Bookings", "Sort Bookings", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    public static void main(String[] args) {
        ...
        app.processBookings();
        System.out.println("Thank you for using the Nemo Reef Tours Management Program Designed by 12095772");
    }
}
